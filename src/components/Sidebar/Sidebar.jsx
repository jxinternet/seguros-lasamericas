    ...
    return (
      <aside className={style.contentSidebar}>
        <Link href={"/"} className="flex gap-1 mb-4">
          ...
          <span>Agencia de Seguros y Fianzas Las Américas</span>
        </Link>
        ...
        {session ? (
          <nav className="flex flex-col gap-2">
            ...
            <Link href="/soporte" className={activeLink}>
            <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
          viewBox="0 0 24 24"
          ...
          <nav className="flex flex-col gap-2">
            <Link href="/login" className={activeLink}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <Link href="/register" className={activeLink}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
